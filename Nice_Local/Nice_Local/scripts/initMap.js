function initMap(locations = allLocations) {
          ...
          function filterLocations() {
              ...
              //var addressInput = document.getElementById('addressInput').value.replace(/[^a-z0-9\s]/gi, '');
              var addressInput = document.getElementById('addressInput').value;
              var maxRadius = document.getElementById('radiusSelect').value;

              if (addressInput && maxRadius) {
                  userLatLng = getLatLngViaHttpRequest(addressInput);
              }
              ...
              function getLatLngViaHttpRequest(address) {
                  ...
                  var addressStripped = address;
                  // var key = MY_API_KEY;
                  var key = 'AIzaSyCyA2duiQS4Kp3HQVqFrtWL7uEkLdfmMCU';
                  ...
                  $.get(request, function (data) {
                      ...
                      if (filteredLocations.length > 0) {
                          ...
                          searchResultsAlert.innerHTML = 'Agents within ' + maxRadius + ' miles of ' + addressInput + ':';
                      } else {
                          console.log("nothing found!");
                          document.getElementById('locations-near-you').innerHTML = '';
                          searchResultsAlert.innerHTML = 'Sorry, no agents were found within ' + maxRadius + ' miles of ' + addressInput + '.';
                      }
